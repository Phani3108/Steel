"""jai-brakes — the brakes: HITL approval gates and the agent kill switch.
...
from jai_brakes.approvals import Approvals
from jai_brakes.killswitch import KillSwitch
