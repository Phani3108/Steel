...
steel-mcp owns two schema namespaces (ADR-003): ``sourcing`` (RFx events + bids) and
...
(precedent: apps/api/src/steel_api/queries.py).
"""
...
def ensure_schemas() -> None:
    """Idempotently create steel-mcp's own namespaces: sourcing + intake."""
