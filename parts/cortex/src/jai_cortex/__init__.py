"""jai-cortex — the chassis: permission-aware procurement semantic layer.
...
from jai_cortex.acl import ROLE_TYPES, allowed_types
from jai_cortex.cortex import Cortex
