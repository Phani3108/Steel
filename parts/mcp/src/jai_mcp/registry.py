...
as MCP tools. ``in_process_tools()`` is THE seam jai-engine consumes next phase:
...
from jai_mcp import contracts_server, intake, sourcing_events, spend_analytics, supplier_master
