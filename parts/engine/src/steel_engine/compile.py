...
from steel_gateway import GatewayResponse
from steel_manifest import AgentManifest, AuditEvent, Outcome, RunContext, sha256_hex
...
# guard_in's deny-list: a deliberately tiny stub for steel-governor's real injection
...
class GatewayPort(Protocol):
    """The slice of steel_gateway.GatewayClient the engine calls."""
...
class BlackboxPort(Protocol):
    """The slice of steel_blackbox.BlackBox the engine calls."""

    def append(self, event: AuditEvent) -> str: ...


class MeterPort(Protocol):
    """The slice of steel_meter.Meter the engine calls."""
...
class RetrieverPort(Protocol):
    """What a rag-pipeline retriever must return (duck-typed: steel-cortex satisfies it,
