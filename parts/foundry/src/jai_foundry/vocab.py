...
# ── Policy documents ─────────────────────────────────────────────────────────────────────
# Approval limits keyed by jai_manifest.Role names — the contract layer defines the roles,
...
if not set(APPROVAL_LIMITS_USD) <= _known_roles:
    raise RuntimeError("APPROVAL_LIMITS_USD keys must be jai_manifest.Role values")
