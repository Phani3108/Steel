...
These models are the published shape of every JSONL file ``steel_foundry.generate`` writes
and every row ``steel_foundry.load`` inserts into the ``foundry`` Postgres schema.
"""
