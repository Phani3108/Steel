"""Command-line interface: ``steel-foundry generate`` / ``steel-foundry load``."""
...
from steel_foundry.load import load
...
def main(argv: list[str] | None = None) -> int:
    ...
    ld.add_argument("--from", dest="from_dir", type=Path, required=True,
                    help="directory previously written by `steel-foundry generate`")
